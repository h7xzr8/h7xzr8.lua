...
local Window = Fluent:CreateWindow({Title = "❤️Drak Hub❤️",SubTitle = "| By:Drak ",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Rose",MinimizeKey = Enum.KeyCode.End})
